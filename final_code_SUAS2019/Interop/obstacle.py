...
#client = client.Client(url='http://192.168.43.124:8000', username='testuser', password='testpass')
...
r = DictObj["stationaryObstacles"]
jsonObj = json.dumps(r)

with open('obstacle.json', 'w') as outfile:  
